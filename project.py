...
# retrieving the file paths of all the reviews with corresponding class label values
allFiles = {
    0: 'test/neg',
    0: 'train/neg',
    1: 'test/pos',
...
# writing the data from the text files to an initial .csv file
...
# set the name for a new .csv file to fill up
...
# otherwise, generate newly formatted data
else:
